...
## Frontend Frameworks
- **Refine.dev (React):** A high-level framework specialized for rapid development of data-intensive administrative and monitoring interfaces.
- **Ant Design:** The primary UI component library, providing a professional and standardized industrial look and feel.
- **React Query:** Managing server state and caching for ultra-responsive data fetching.
- **Appwrite Web SDK:** For seamless integration with the backend and real-time event handling.

## Deployment & Environments
- **Containerization:** All system components are containerized using **Docker** and orchestrated via **Docker Compose** for consistent behavior across hosts.
- **Dual Environments:**
...
- **GitHub Actions:** Automates the testing and build process upon every code push.
